      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-card border border-border rounded-xl p-6 shadow-sm">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 border border-border rounded-lg px-4 py-3 text-sm font-medium hover:bg-muted transition-colors"
          >
