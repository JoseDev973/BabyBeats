...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 bg-gradient-to-b from-secondary/30 to-background">
      <div className="w-full max-w-md">
        ...
        <div className="bg-card border border-border rounded-xl p-6 shadow-sm">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 border border-border rounded-lg px-4 py-3 text-sm font-medium hover:bg-muted transition-colors disabled:opacity-50"
          >
            {googleLoading ? (
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            <div>
              <label htmlFor="signup-confirm-password" className="text-sm font-medium mb-1.5 block">
                {t("confirmPassword")}
              </label>
              <div className="relative">
                <Lock className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" />
